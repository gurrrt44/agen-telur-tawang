  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        {open && (
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <h4 className="font-serif text-lg font-semibold">Hubungi Kami</h4>
              ...
              <button
                ...
                className="ml-2 shrink-0 rounded-full p-1 text-muted-foreground transition hover:bg-secondary hover:text-foreground"
              >
                <X className="size-4" />
              </button>
            </div>
            ...
            <a
              ...
              className="mt-4 flex w-full items-center justify-center gap-2.5 rounded-lg bg-[#25D366] px-4 py-3 font-mono text-sm font-semibold uppercase tracking-wider text-white transition hover:bg-[#1fb855] active:scale-[0.98]"
            >
            ...
            <div className="mt-3 flex items-center gap-2 text-[10px] text-muted-foreground">
              <span className="inline-block size-2 rounded-full bg-[#25D366]" />
      ...
      <motion.button
        ...
        whileHover={{ scale: 1.08 }}
        whileTap={{ scale: 0.95 }}
        className="group relative flex items-center gap-2.5 rounded-full bg-[#25D366] py-3 pl-4 pr-5 font-mono text-sm font-semibold text-white shadow-lg shadow-[#25D366]/30 transition-all hover:shadow-xl hover:shadow-[#25D366]/40"
      >
        {/* Pulse ring */}
