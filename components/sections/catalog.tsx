              ...
              <CursorGlowCard className="catalog-card flex h-full flex-col border border-border bg-card p-7 transition hover:border-transparent">
                ...
                <div className="mt-5">
                  ...
                  <button
                    ...
                    className="sm:hidden inline-flex w-full items-center justify-center gap-2 rounded-sm bg-foreground px-5 py-3 font-mono text-xs font-semibold uppercase tracking-[0.14em] text-background active:scale-95"
                  >
